...
public class Activity01 {
    ...
    public static void main(String[] args) {
        ...
        // Print line the statement "World population in 1950: " followed by the sum of all of the continents' populations.

        //The current population of Asia is an estimated 60% of the world population
        double percentAsia = 0.6;

        // Uncomment the two lines below and fix the error by casting the data type correctly.
